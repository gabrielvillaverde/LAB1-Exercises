/*
 ============================================================================
Pedir al usuario dos números float:
...
Si no hubo errores, imprimir el resultado: "La suma es...", etcétera..
Todas las funciones, hay que hacer, que si salieron bien:

- return = 0 Salió bien.
- return = -1 Si salieron mal.
...
int dividir(float operadorA, float operadorB, float *pResultado) {
	...
	int retorno = -1; // Siempre saldrá mal.

	if (operadorB != 0) {
		*pResultado = operadorA / operadorB;
		retorno = 0; // Salió bien.
	}
